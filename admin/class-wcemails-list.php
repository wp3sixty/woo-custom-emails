...
if ( ! class_exists( 'WCEmails_List' ) ) {
	...
	public function column_wcemails_title( $item ) {
			$edit_url   = add_query_arg(
				...
				admin_url( 'admin.php?page=wcemails-settings' )
				);
		...
		<strong><a class="row-title"
			...
			title="
						...
						echo esc_attr( sprintf( __( 'Edit "%s"', 'woo-custom-emails' ), $item['title'] ) );
						?>
		...
		<div class="row-actions">
			<span class="edit">
				<a href="<?php echo esc_url( $edit_url ); ?>"
					...
					title="<?php esc_attr_e( 'Edit this item', 'woo-custom-emails' ); ?>">
							<?php
							esc_html_e( 'Edit', 'woo-custom-emails' );
							?>
				</a> |
			</span>
			<span class="delete">
				<a href="<?php echo esc_url( $delete_url ); ?>"
					...
					data-key="<?php echo esc_attr( $item['ID'] ); ?>"
					title="<?php esc_attr_e( 'Delete this item', 'woo-custom-emails' ); ?>">
							<?php
							esc_html_e( 'Delete', 'woo-custom-emails' );
							?>
				</a> |
			</span>
		</div>
